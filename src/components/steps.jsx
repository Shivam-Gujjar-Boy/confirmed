...
Steps.defaultProps = {
  step1Description:
    'Sign up for a Destiny Labs account to participate in airdrops and unlock exclusive rewards.',
  step3Description:
    'Connect with fellow crypto enthusiasts in our community to boost engagement and excitement.',
  step2Title: 'Engage with Wallet',
  step2Description:
    'Stay active with your wallet to increase your chances of receiving tokens in our airdrops.',
  step1Title: 'Create an Account',
  step3Title: 'Join the Community',
  step4Description:
    'Once selected, claim your tokens and start exploring the possibilities within the Destiny Labs ecosystem.',
